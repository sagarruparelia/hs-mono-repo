  ...
  return (
    <div className="landing-page">
      <div className="hero-section">
        <h1 className="hero-title">Welcome to Web CL</h1>
        <p className="hero-subtitle">
          Your comprehensive client portal for managing your account and viewing insights
        </p>
      ...
      <div className="features-section">
        ...
        <div className="feature-grid">
          ...
          <div className="feature-item">
            ...
            <p>Access detailed summaries and insights about your account activity</p>
          </div>
