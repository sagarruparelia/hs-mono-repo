...
const API_TIMEOUT = Number("30000") || 3e4;
...
const queryKeys = {
  ...
  profile: {
    all: ["profile"],
    byUserId: (userId) => [...queryKeys.profile.all, userId],
    avatar: (userId) => [...queryKeys.profile.byUserId(userId), "avatar"]
  },
  /**
   * Summary keys
   */
  summary: {
    all: ["summary"],
    byUserId: (userId) => [...queryKeys.summary.all, userId],
    filtered: (userId, params) => [...queryKeys.summary.byUserId(userId), params]
  }
};
...
function useProfile(userId) {
  ...
  const updateMutation = useMutation({
    mutationFn: (data) => profileApi.updateProfile(userId, data),
  ...
  const uploadAvatarMutation = useMutation({
    ...
    onSuccess: (data) => {
      queryClient.setQueryData(
        ...
        (old) => old ? { ...old, avatar: data.avatarUrl } : void 0
      );
    }
  });
  return {
...
function ProfilePageContent({ userId = "demo-user", theme = "light", onUpdate }) {
  const {
    profile,
    isLoading,
    isError,
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `profile-page profile-page--${theme}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-loading", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "spinner" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading profile..." })
    ] }) });
  }
  if (isError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `profile-page profile-page--${theme}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-error", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Error Loading Profile" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: error?.message || "Failed to load profile data" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.location.reload(), className: "btn-retry", children: "Retry" })
    ] }) });
  }
  if (!profile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `profile-page profile-page--${theme}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-empty", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No profile data available" }) }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `profile-page profile-page--${theme}`, "data-user-id": userId, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "User Profile" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-avatar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: profile.avatar || "https://via.placeholder.com/150", alt: "Profile" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-details", children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        ...
        updateError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error-message", children: updateError.message || "Failed to update profile" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleSave,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: profile.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "profile-email", children: profile.email }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "profile-bio", children: profile.bio })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-stats", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-value", children: "42" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-label", children: "Projects" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-value", children: "1.2K" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-label", children: "Followers" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-value", children: "850" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "stat-label", children: "Following" })
      ] })
    ] })
  ] });
}
function ProfilePage(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProfilePageContent, { ...props }) });
}
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "profile-tabs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-content", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    false
  ] });
}
...
function SettingsComponent() {
  const context = Route$2.useRouteContext();
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `profile-loading profile-page--${theme}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "spinner" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading settings..." })
    ] });
  }
  if (!profile) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `profile-empty profile-page--${theme}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No profile data available" }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `profile-settings profile-page--${theme}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Profile Settings" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-form", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Name:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
      ...
      updateError && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error-message", children: updateError.message || "Failed to update profile" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleSave, className: "btn-save", disabled: isUpdating, children: isUpdating ? "Saving..." : "Save Changes" })
    ] })
  ] });
}
...
function ActivityComponent() {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `profile-loading profile-page--${theme}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "spinner" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Loading activity..." })
    ] });
  }
  const activities = [
    {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `profile-activity profile-page--${theme}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Recent Activity" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "activity-subtitle", children: "Your recent actions and updates" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "activity-list", children: activities.map((activity) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "activity-item", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "activity-details", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "activity-description", children: activity.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "activity-timestamp", children: new Date(activity.timestamp).toLocaleString() })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `activity-badge activity-badge--${activity.type}`, children: activity.type })
    ] }, activity.id)) }),
    profile && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "activity-summary", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Total activities this month: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "23" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "Most active day: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Monday" })
      ] })
    ] })
  ] });
}
...
function OverviewComponent() {
  const context = Route2.useRouteContext();
  const { userId = "demo-user", theme = "light" } = context || {};
  ...
  if (isError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `profile-error profile-page--${theme}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Error Loading Profile" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: error?.message || "Failed to load profile data" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => window.location.reload(), className: "btn-retry", children: "Retry" })
    ] });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `profile-overview profile-page--${theme}`, "data-user-id": userId, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Profile Overview" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "profile-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "profile-avatar", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: profile.avatar || "https://via.placeholder.com/150", alt: "Profile" }) }),
...
const routeTree = Route$3.addChildren({
  IndexRoute,
  ActivityRoute,
  SettingsRoute
});
const createMFERouter = (initialRoute = "/") => {
...
function ProfilePageWithRouter({
  userIdType = "EID",
  userIdValue,
  loggedInUserIdType,
  loggedInUserIdValue,
  ...
  const queryClient = getSharedQueryClient();
  const routerRef = reactExports.useRef(createMFERouter(route));
  ...
  }, [router, effectiveUserId, userIdType, userIdValue, loggedInUserIdType, loggedInUserIdValue, theme, onUpdate]);
  reactExports.useEffect(() => {
...
class ProfilePageElement extends HTMLElement {
  ...
  mount() {
    ...
    const userIdValue = this.getAttribute("user-id-value") || this.getAttribute("user-id") || void 0;
    const loggedInUserIdType = this.getAttribute("logged-in-user-id-type") || void 0;
    const loggedInUserIdValue = this.getAttribute("logged-in-user-id-value") || void 0;
    const route = this.getAttribute("route") || "/";
    const useRouter2 = this.getAttribute("use-router") === "true";
    if (!this.root) {
      this.root = clientExports.createRoot(this);
    }
    if (useRouter2 || this.hasAttribute("route")) {
      this.root.render(
        /* @__PURE__ */ jsxRuntimeExports.jsx(
