/**
 * Profile Page with Memory Router
 *
 * Framework-agnostic routed version of ProfilePage.
...
export interface ProfilePageWithRouterProps {
  ...
  // UI and routing
  theme?: 'light' | 'dark';
  route?: string; // Initial route path (e.g., '/', '/settings', '/activity')
...
export function ProfilePageWithRouter({
  userIdType = 'EID',
  userIdValue,
  loggedInUserIdType,
  loggedInUserIdValue,
